...
with ontologia:
    ...
    class Grupo_investigacion(Thing):
        ...
        def set_clasificacion_grupo_investigacion(self, clasificacion_grupo_investigacion):
            self.clasificacion_grupo_investigacion = [
                clasificacion_grupo_investigacion]
